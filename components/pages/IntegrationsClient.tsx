...
import mockData from '@/data/marketing/integrations.json';
    ...
    <main className="bg-bg min-h-screen text-fg-strong">
      ...
      <section className="pt-16 md:pt-32 pb-12 md:pb-20 px-4 sm:px-6 md:px-8">
        <div className="max-w-[1400px] mx-auto">
          <AnimatedSection>
            ...
            <h1 className="heading-primary text-gradient-aurora mb-8">
      ...
      <section className="py-8 md:py-12 border-t border-border">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 md:px-8">
          <AnimatedSection>
            <h2 className="heading-primary text-gradient-aurora text-center mb-6 md:mb-8">INTEGRATION CAPABILITIES</h2>
          </AnimatedSection>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <AnimatedSection delay={0.1}>
              <div className="p-6 border border-border rounded-lg hover:border-border-strong transition-colors min-h-[200px]">
                ...
                <p className="text-sm text-fg-muted">100+ ready-to-use enterprise integrations</p>
              </div>
            </AnimatedSection>
            ...
            <AnimatedSection delay={0.2}>
              <div className="p-6 border border-border rounded-lg hover:border-border-strong transition-colors min-h-[200px]">
                ...
                <p className="text-sm text-fg-muted">Build custom integrations with SDKs</p>
              </div>
            </AnimatedSection>
            ...
            <AnimatedSection delay={0.3}>
              <div className="p-6 border border-border rounded-lg hover:border-border-strong transition-colors min-h-[200px]">
                ...
                <p className="text-sm text-fg-muted">Map data flows without coding</p>
              </div>
            </AnimatedSection>
            ...
            <AnimatedSection delay={0.4}>
              <div className="p-6 border border-border rounded-lg hover:border-border-strong transition-colors min-h-[200px]">
                ...
                <p className="text-sm text-fg-muted">OAuth2, API keys, SSO support</p>
              </div>
            </AnimatedSection>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 md:gap-16 items-center">
            ...
            <AnimatedSection>
              <div className="space-y-8">
                <div>
                  <h2 className="heading-primary text-gradient-aurora mb-6">100+ Pre-Built Enterprise Connectors</h2>
            ...
            <AnimatedSection delay={0.2}>
              <div className="relative">
                <div className="border border-border rounded-lg p-5 md:p-8 bg-gradient-to-br from-blue-500/5 to-cyan-500/5">
                  {/* Category Tabs */}
                  <div className="grid grid-cols-2 gap-2 mb-8">
                    {Object.entries(integrationCategories).map(([key, cat]) => (
                      ...
                      >
                        ...
                        <div className="text-sm text-fg-muted">{cat.count} connectors</div>
                      </button>
                    ))}
                  </div>
                  ...
                  <div className="space-y-3">
                    {integrationCategories[activeCategory].examples.map((name, idx) => (
                      <div key={idx} className="flex items-center gap-3 p-3 bg-bg/40 rounded-lg">
        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 md:px-8">
          <div className="grid lg:grid-cols-2 gap-8 md:gap-16 items-center">
            ...
            <AnimatedSection delay={0.2}>
              <div className="space-y-8">
                <div>
                  <h2 className="heading-primary text-gradient-aurora mb-6">Custom Integration Framework</h2>
                  <p className="text-base sm:text-lg md:text-xl text-fg-mid">
        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 md:px-8">
          <div className="grid lg:grid-cols-2 gap-8 md:gap-16 items-center">
            ...
            <AnimatedSection>
              <div className="space-y-8">
                <div>
                  <h2 className="heading-primary text-gradient-aurora mb-6">API Management & Orchestration</h2>
                  <p className="text-base sm:text-lg md:text-xl text-fg-mid">
        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 md:px-8">
          <div className="grid lg:grid-cols-2 gap-8 md:gap-16 items-center">
            ...
            <AnimatedSection delay={0.2}>
              <div className="space-y-8">
                <div>
                  <h2 className="heading-primary text-gradient-aurora mb-6">Enterprise System Support</h2>
                  <p className="text-base sm:text-lg md:text-xl text-fg-mid">
        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 md:px-8 text-center">
          <AnimatedSection>
            <div className="mb-6 md:mb-12">
              ...
              <h2 className="heading-primary text-gradient-aurora mb-4">BUILT WITH AI CoE GOVERNANCE</h2>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
              <div>
                ...
                <p className="text-sm text-fg-muted">Role-based permissions with complete audit logging</p>
              </div>
              ...
              <div>
                ...
                <p className="text-sm text-fg-muted">Automatic PII detection and data residency enforcement</p>
              </div>
              ...
              <div>
                ...
                <p className="text-sm text-fg-muted">Real-time health monitoring with automatic alerts</p>
              </div>
            </div>
          </AnimatedSection>
        </div>
      ...
      <section className="py-8 md:py-12 border-t border-border">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 md:px-8">
          <AnimatedSection>
            <h2 className="heading-primary text-gradient-aurora text-center mb-6 md:mb-8">INTEGRATION CATEGORIES</h2>
          </AnimatedSection>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <AnimatedSection delay={0.1}>
              <div className="p-5 md:p-8 border border-border rounded-lg hover:border-border-strong transition-colors">
                ...
                <p className="text-sm text-fg-muted mb-4">25+ connectors</p>
            ...
            <AnimatedSection delay={0.2}>
              <div className="p-5 md:p-8 border border-border rounded-lg hover:border-border-strong transition-colors">
                ...
                <p className="text-sm text-fg-muted mb-4">20+ connectors</p>
                <div className="space-y-2 text-sm text-fg-subtle">
                  <p>• SAP</p>
                  <p>• Oracle ERP</p>
                  <p>• NetSuite</p>
            ...
            <AnimatedSection delay={0.3}>
              <div className="p-5 md:p-8 border border-border rounded-lg hover:border-border-strong transition-colors">
                ...
                <p className="text-sm text-fg-muted mb-4">15+ connectors</p>
                <div className="space-y-2 text-sm text-fg-subtle">
                  <p>• Slack</p>
                  <p>• Microsoft Teams</p>
                  <p>• Zoom</p>
      ...
      <section className="py-8 md:py-12 border-t border-border">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 md:px-8">
          <AnimatedSection>
            <h2 className="heading-primary text-gradient-aurora text-center mb-6 md:mb-8">EXPLORE MORE PLATFORM FEATURES</h2>
          </AnimatedSection>
            ...
            <AnimatedSection delay={0.1}>
              <Link href="/platform/ai-engineering-tools">
                <div className="p-6 border border-border rounded-lg hover:border-border-strong transition-all h-full">
                  ...
                  <p className="text-sm text-fg-muted">Build and test AI agents</p>
                </div>
              </Link>
            </AnimatedSection>
            ...
            <AnimatedSection delay={0.2}>
              <Link href="/platform/search-data-ai">
                <div className="p-6 border border-border rounded-lg hover:border-border-strong transition-all h-full">
                  ...
                  <p className="text-sm text-fg-muted">Vector search and data preparation</p>
                </div>
              </Link>
            </AnimatedSection>
            ...
            <AnimatedSection delay={0.3}>
              <Link href="/platform/security-governance">
                <div className="p-6 border border-border rounded-lg hover:border-border-strong transition-all h-full">
                  ...
                  <p className="text-sm text-fg-muted">Enterprise-grade security</p>
                </div>
              </Link>
            </AnimatedSection>
            ...
            <AnimatedSection delay={0.4}>
              <Link href="/platform/development-tools">
                <div className="p-6 border border-border rounded-lg hover:border-border-strong transition-all h-full">
                  ...
                  <p className="text-sm text-fg-muted">No-code and pro-code options</p>
                </div>
              </Link>
            </AnimatedSection>
          </div>
