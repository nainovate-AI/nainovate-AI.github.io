    ...
    <main className="bg-bg min-h-screen text-fg-strong">
      ...
      <section className="py-8 md:py-12 border-t border-border">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 md:px-8">
          <AnimatedSection>
            <h2 className="heading-primary text-center mb-6 md:mb-8">INTEGRATION CAPABILITIES</h2>
          </AnimatedSection>
          ...
          <div className="grid lg:grid-cols-2 gap-8 md:gap-16 items-center">
            ...
            <AnimatedSection>
              <div className="space-y-8">
                <div>
                  <h2 className="heading-primary mb-6">100+ Pre-Built Enterprise Connectors</h2>
        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 md:px-8">
          <div className="grid lg:grid-cols-2 gap-8 md:gap-16 items-center">
            ...
            <AnimatedSection delay={0.2}>
              <div className="space-y-8">
                <div>
                  <h2 className="heading-primary mb-6">Custom Integration Framework</h2>
                  <p className="text-base sm:text-lg md:text-xl text-fg-mid">
        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 md:px-8">
          <div className="grid lg:grid-cols-2 gap-8 md:gap-16 items-center">
            ...
            <AnimatedSection>
              <div className="space-y-8">
                <div>
                  <h2 className="heading-primary mb-6">API Management & Orchestration</h2>
                  <p className="text-base sm:text-lg md:text-xl text-fg-mid">
        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 md:px-8">
          <div className="grid lg:grid-cols-2 gap-8 md:gap-16 items-center">
            ...
            <AnimatedSection delay={0.2}>
              <div className="space-y-8">
                <div>
                  <h2 className="heading-primary mb-6">Enterprise System Support</h2>
                  <p className="text-base sm:text-lg md:text-xl text-fg-mid">
      ...
      <section className="py-8 md:py-12 border-t border-border">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 md:px-8">
          <AnimatedSection>
            <h2 className="heading-primary text-center mb-6 md:mb-8">INTEGRATION CATEGORIES</h2>
          </AnimatedSection>
