              ...
              <div key={s.id} className="grid lg:grid-cols-12 gap-6 md:gap-12 border-t border-white/10 pt-8 md:pt-16">
                <div className="lg:col-span-4">
                  ...
                  <ul className="mt-3 space-y-2">
                    {s.signals.map((sig) => (
                      <li key={sig} className="text-sm text-gray">
                        · {sig}
                      </li>
                    ))}
                  </ul>
                ...
                <div className="lg:col-span-8 space-y-6">
                  ...
                  <div className="border-l-2 border-white pl-6 mt-6">
                    <p className="text-sm text-gray uppercase tracking-wider mb-2">Outcome</p>
                    <p className="text-white">{s.outcome}</p>
                  </div>
                </div>
              </div>
            ))}
