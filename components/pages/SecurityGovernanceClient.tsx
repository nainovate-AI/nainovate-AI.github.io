...
import mockData from '@/data/security-governance.json';
  ...
  return (
    <main className="bg-black min-h-screen text-white">
          ...
          <AnimatedSection>
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 flex-wrap">
              <Link href="/contact" className="w-full sm:w-auto">
                <Button className="w-full sm:w-auto border border-white/20 hover:bg-white/10 hover:text-white px-6 py-3 sm:px-8 sm:py-4 text-lg">                  Schedule Security Demo
                </Button>
              </Link>
            </div>
          </AnimatedSection>
      ...
      {mockData.detailSections.map((section) => {
        ...
        return (
          <section key={section.id} className="py-16 md:py-32 border-t border-white/10">
            <div className="max-w-[1400px] mx-auto px-4 sm:px-6 md:px-8">
