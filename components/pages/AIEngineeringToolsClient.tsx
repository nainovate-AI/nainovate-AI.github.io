...
import mockData from '@/data/ai-engineering-tools.json';
...
export default function AIEngineeringToolsClient() {
  return (
    <main className="bg-black min-h-screen text-white">
      ...
      {mockData.detailSections.map((section, sIdx) => {
          ...
          <AnimatedSection>
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center flex-wrap">
              ...
              <Link href="/platform/core" className="w-full sm:w-auto">
                <Button className="w-full sm:w-auto px-6 py-3 sm:px-8 sm:py-4 border-2 border-white/20 hover:bg-white/10 hover:text-white font-medium">
