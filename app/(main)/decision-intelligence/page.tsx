...
export const metadata: Metadata = {
  ...
  description: 'Turn every ticket, signal, and AI decision into explainable outcomes. Nia sits on the Incident Management Tool, CRM, and knowledge bases as a decision intelligence layer for support, success, sales, and delivery teams.',
