                    ...
                    <AnimatedSection>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            <Link href="/contact" className="w-full sm:w-auto">
                                <button className="w-full sm:w-auto group relative overflow-hidden border border-white/20">
                            ...
                            <Link href="/ai-center-of-excellence" className="w-full sm:w-auto">
                                <button className="w-full sm:w-auto px-8 py-4 text-gray hover:text-white transition-colors border border-white/10">
